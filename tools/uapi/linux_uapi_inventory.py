...
EDGEOS_ASSESSMENTS = [
    ...
    },
    {
        ...
        "implemented": [
            ...
            "READ_FIXED and WRITE_FIXED through pinned pages for regular files, pipes, stream sockets, pseudo-terminals and memory character devices",
        ...
        "missing": [
            ...
            "pinned reads from physical terminals and device-specific character descriptors without kernel-buffer backends",
            "SQPOLL wait control",
