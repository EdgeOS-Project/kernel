...
EDGEOS_ASSESSMENTS = [
    ...
    },
    {
        ...
        "missing": [
            "remaining map types, socket-map and reuseport program attachment and redirect execution, reuseport disconnect-time removal, cgroup local-storage helper access and owner-removal cleanup, deprecated cgroup-storage attachment integration, stack-trace helper population, CPU-map packet redirect execution, device-map packet redirect execution and AF_XDP socket-backed XSK-map entries",
