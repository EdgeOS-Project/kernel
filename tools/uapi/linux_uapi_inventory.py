...
EDGEOS_ASSESSMENTS = [
    {
        ...
        "linux_oracle": {
            ...
            "scope": (
                ...
                "for standard groups and parameters above 8192 bits with "
    ...
    },
    {
        ...
        "implemented": [
            ...
            "ia32 and x32 OPENAT, STATX, FTRUNCATE and UNLINKAT path-operation layouts",
        ...
        "linux_oracle": {
            ...
            "scope": (
                ...
                "mappings, plus physical queue-zero device registration, "
                "exclusive ownership and retained provider lifetime with a "
                "socket-copy fallback, "
    ...
    },
    {
        ...
        "linux_oracle": {
            ...
            "scope": (
                ...
                "insertion, replacement, deletion, reference lifetime, "
                "owner-removal cleanup with retained-reference balancing and "
                ...
                "cleanup, deletion and unsupported "
                "iteration, "
...
COVERAGE_ASSESSMENTS = [
    ...
    coverage_assessment(
        ...
        runtime_tests=[
            ...
            "tools/tests/ia32_io_privilege_uapi_probe.c",
            "tools/tests/ia32_kexec_load_uapi_probe.c",
            "tools/tests/ia32_keyctl_compat_uapi_probe.c",
            "tools/tests/compat_io_uring_iovec_uapi_probe.c",
            "tools/tests/compat_userfaultfd_uapi_probe.c",
            "tools/tests/compat_bpf_uapi_probe.c",
