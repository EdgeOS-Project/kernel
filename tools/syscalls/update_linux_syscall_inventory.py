...
VERIFIED_SYSCALL_PROBES = {
    ...
    "add_key": "tools/tests/keyring_abi_probe.c",
    ...
    "fadvise64": "tools/tests/file_advice_abi_probe.c",
    "fallocate": "tools/tests/fallocate_abi_probe.c",
    "faccessat": "tools/tests/metadata_mutation_abi_probe.c",
    "faccessat2": "tools/tests/metadata_mutation_abi_probe.c",
    "fanotify_init": "tools/tests/fanotify_abi_probe.c",
    "fanotify_mark": "tools/tests/fanotify_abi_probe.c",
    "file_getattr": "tools/tests/fileattr_abi_probe.c",
    "file_setattr": "tools/tests/fileattr_abi_probe.c",
    ...
    "finit_module": "tools/tests/module_abi_probe.c",
    ...
    "fsconfig": "tools/tests/mount_context_abi_probe.c",
    "fsmount": "tools/tests/mount_context_abi_probe.c",
    "fsopen": "tools/tests/mount_context_abi_probe.c",
    "fspick": "tools/tests/mount_context_abi_probe.c",
    "fsync": "tools/tests/sync_abi_probe.c",
    "fork": "tools/tests/x86_64_legacy_syscall_probe.c",
    "ftruncate": "tools/tests/truncate_abi_probe.c",
    "futex": "tools/tests/futex_abi_probe.c",
    "futex_requeue": "tools/tests/futex_abi_probe.c",
    "futex_wait": "tools/tests/futex_abi_probe.c",
    "futex_waitv": "tools/tests/futex_abi_probe.c",
    "futex_wake": "tools/tests/futex_abi_probe.c",
    "futimesat": "tools/tests/metadata_mutation_abi_probe.c",
    "getitimer": "tools/tests/itimer_abi_probe.c",
    "get_robust_list": "tools/tests/synchronization_registration_abi_probe.c",
    ...
    "getpeername": "tools/tests/socket_address_abi_probe.c",
    ...
    "getxattrat": "tools/tests/xattrat_abi_probe.c",
    "getuid": "tools/tests/shared_syscall_smoke.c",
    "getrlimit": "tools/tests/resource_accounting_abi_probe.c",
    "getsockname": "tools/tests/socket_address_abi_probe.c",
    "getsockopt": "tools/tests/socket_option_abi_probe.c",
    ...
    "init_module": "tools/tests/module_abi_probe.c",
    "ioctl": "tools/tests/ioctl_abi_probe.c",
    "ioperm": "tools/tests/x86_arch_control_abi_probe.c",
    "iopl": "tools/tests/x86_arch_control_abi_probe.c",
    ...
    "listen": "tools/tests/socket_address_abi_probe.c",
    "listmount": "tools/tests/statmount_abi_probe.c",
    "listns": "tools/tests/listns_abi_probe.c",
    "listxattrat": "tools/tests/xattrat_abi_probe.c",
    "listxattr": "tools/tests/xattr_abi_probe.c",
    "lseek": "tools/tests/lseek_abi_probe.c",
    ...
    "mmap": "tools/tests/mmap_abi_probe.c",
    "mount": "tools/tests/mount_abi_probe.c",
    "mount_setattr": "tools/tests/mount_abi_probe.c",
    "move_mount": "tools/tests/modern_mount_abi_probe.c",
    "mprotect": "tools/tests/mprotect_abi_probe.c",
    "mremap": "tools/tests/mremap_abi_probe.c",
    "mseal": "tools/tests/mseal_abi_probe.c",
    "msync": "tools/tests/msync_abi_probe.c",
    ...
    "munmap": "tools/tests/munmap_abi_probe.c",
    "name_to_handle_at": "tools/tests/file_handle_abi_probe.c",
    "newfstatat": "tools/tests/stat_metadata_abi_probe.c",
    "open": "tools/tests/openat2_abi_probe.c",
    "openat": "tools/tests/openat2_abi_probe.c",
    "openat2": "tools/tests/openat2_abi_probe.c",
    "open_by_handle_at": "tools/tests/file_handle_abi_probe.c",
    "open_tree": "tools/tests/modern_mount_abi_probe.c",
    "open_tree_attr": "tools/tests/mount_context_abi_probe.c",
    "pause": "tools/tests/x86_64_legacy_syscall_probe.c",
    "pipe": "tools/tests/pipe_abi_probe.c",
    "pipe2": "tools/tests/pipe_abi_probe.c",
    "pivot_root": "tools/tests/mount_abi_probe.c",
    "personality": "tools/tests/process_control_abi_probe.c",
    "perf_event_open": "tools/tests/perf_event_abi_probe.c",
    "pidfd_getfd": "tools/tests/pidfd_getfd_abi_probe.c",
    "poll": "tools/tests/poll_abi_probe.c",
    "ppoll": "tools/tests/poll_abi_probe.c",
    ...
    "process_madvise": "tools/tests/process_madvise_abi_probe.c",
    "process_mrelease": "tools/tests/process_mrelease_abi_probe.c",
    "ptrace": "tools/tests/ptrace_abi_probe.c",
    "pselect6": "tools/tests/select_abi_probe.c",
    "pkey_alloc": "tools/tests/pkey_abi_probe.c",
    "pkey_free": "tools/tests/pkey_abi_probe.c",
    "pkey_mprotect": "tools/tests/pkey_abi_probe.c",
    "read": "tools/tests/vector_io_abi_probe.c",
    "readahead": "tools/tests/file_advice_abi_probe.c",
    "readlink": "tools/tests/path_mutation_abi_probe.c",
    "readlinkat": "tools/tests/path_mutation_abi_probe.c",
    "reboot": "tools/tests/reboot_abi_probe.c",
    "readv": "tools/tests/vector_io_abi_probe.c",
    "quotactl_fd": "tools/tests/quota_abi_probe.c",
    ...
    "removexattrat": "tools/tests/xattrat_abi_probe.c",
    ...
    "request_key": "tools/tests/keyring_abi_probe.c",
    ...
    "rseq_slice_yield": "tools/tests/rseq_slice_abi_probe.c",
    ...
    "rt_sigreturn": (
        "tools/tests/signal_altstack_abi_probe.c",
        "tools/tests/signal_wait_mask_abi_probe.c",
    ),
    ...
    "seccomp": "tools/tests/seccomp_abi_probe.c",
    ...
    "select": "tools/tests/select_abi_probe.c",
    "sendfile": "tools/tests/sendfile_abi_probe.c",
    ...
    "set_robust_list": "tools/tests/synchronization_registration_abi_probe.c",
    ...
    "settimeofday": "tools/tests/time_set_abi_probe.c",
    ...
    "setsockopt": "tools/tests/socket_option_abi_probe.c",
    ...
    "setxattrat": "tools/tests/xattrat_abi_probe.c",
    "sigaltstack": "tools/tests/signal_altstack_abi_probe.c",
    ...
    "shutdown": "tools/tests/socket_core_abi_probe.c",
    "socket": "tools/tests/socket_core_abi_probe.c",
    "socketpair": "tools/tests/socket_core_abi_probe.c",
    "stat": "tools/tests/stat_metadata_abi_probe.c",
    "statfs": "tools/tests/statfs_abi_probe.c",
    "statmount": "tools/tests/statmount_abi_probe.c",
    "statx": "tools/tests/stat_metadata_abi_probe.c",
    "swapoff": "tools/tests/x86_64_legacy_syscall_probe.c",
    "swapon": "tools/tests/x86_64_legacy_syscall_probe.c",
    "splice": "tools/tests/splice_abi_probe.c",
    ...
    "syslog": "tools/tests/syslog_abi_probe.c",
    ...
    "tee": "tools/tests/tee_abi_probe.c",
