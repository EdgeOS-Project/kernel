...
static u8 ath12k_wmi_ignore_num_extra_rules(const struct ath12k_wmi_reg_rule_ext_params *rule,
					    u32 num_reg_rules)
{
...
#elif defined(__FreeBSD__)
	const __le32 *wmi_ext2_service_bitmap;
#endif
	int i, j;
	u16 expected_len;
...
#elif defined(__FreeBSD__)
		wmi_ext2_service_bitmap = (const __le32 *)ptr;
#endif
