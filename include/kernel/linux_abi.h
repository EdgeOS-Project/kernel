...
#define EDGE_LINUX_SO_GET_FILTER EDGE_LINUX_SO_ATTACH_FILTER
#define EDGE_LINUX_SO_DETACH_FILTER 27u
#define EDGE_LINUX_SO_LOCK_FILTER 44u
#define EDGE_LINUX_SO_ATTACH_BPF 50u
...
#define EDGE_LINUX_SO_TIMESTAMPING 37u
...
#define EDGE_LINUX_SO_TIMESTAMPING_NEW 65u
...
#define EDGE_LINUX_SOF_TIMESTAMPING_TX_HARDWARE   (1u << 0)
#define EDGE_LINUX_SOF_TIMESTAMPING_TX_SOFTWARE   (1u << 1)
#define EDGE_LINUX_SOF_TIMESTAMPING_RX_HARDWARE   (1u << 2)
#define EDGE_LINUX_SOF_TIMESTAMPING_RX_SOFTWARE   (1u << 3)
#define EDGE_LINUX_SOF_TIMESTAMPING_SOFTWARE      (1u << 4)
#define EDGE_LINUX_SOF_TIMESTAMPING_SYS_HARDWARE  (1u << 5)
#define EDGE_LINUX_SOF_TIMESTAMPING_RAW_HARDWARE  (1u << 6)
#define EDGE_LINUX_SOF_TIMESTAMPING_OPT_ID        (1u << 7)
#define EDGE_LINUX_SOF_TIMESTAMPING_TX_SCHED      (1u << 8)
#define EDGE_LINUX_SOF_TIMESTAMPING_TX_ACK        (1u << 9)
#define EDGE_LINUX_SOF_TIMESTAMPING_OPT_CMSG      (1u << 10)
#define EDGE_LINUX_SOF_TIMESTAMPING_OPT_TSONLY    (1u << 11)
#define EDGE_LINUX_SOF_TIMESTAMPING_OPT_STATS     (1u << 12)
#define EDGE_LINUX_SOF_TIMESTAMPING_OPT_PKTINFO   (1u << 13)
#define EDGE_LINUX_SOF_TIMESTAMPING_OPT_TX_SWHW   (1u << 14)
#define EDGE_LINUX_SOF_TIMESTAMPING_BIND_PHC      (1u << 15)
#define EDGE_LINUX_SOF_TIMESTAMPING_OPT_ID_TCP    (1u << 16)
#define EDGE_LINUX_SOF_TIMESTAMPING_OPT_RX_FILTER (1u << 17)
#define EDGE_LINUX_SOF_TIMESTAMPING_TX_COMPLETION (1u << 18)
#define EDGE_LINUX_SOF_TIMESTAMPING_MASK \
    ((1u << 19) - 1u)

struct edge_linux_so_timestamping {
    int32_t flags;
    int32_t bind_phc;
};
